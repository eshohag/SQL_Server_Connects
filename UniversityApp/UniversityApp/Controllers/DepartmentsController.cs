...
namespace UniversityApp.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public ActionResult DeptWiseStudent(int? id)
        {
            var allStudent = db.Students.Where(m => m.DepartmentID == id);

            return View(allStudent);
        }
        public ActionResult DeptWiseCourse(int? id)
        {
            var allCourseList = db.Courses.Where(m => m.DepartmentID == id);
            var deptName = db.Departments.Find(id);
            ViewBag.DeptName = deptName.Name;
